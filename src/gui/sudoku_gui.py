...
from .function.timer import CountDown
...
class GUI(STYLE):
    ...
    def right_side_option_block(self):
        ...
        speed_game = tk.Button(help_label_frame, text = "Solve", command=lambda : self.speed_visual_solve_button_action(False))
        ...
        # {1-2-4} Solve LabelFrame = [ visual, Speed ]
        # +------------------------------+
        # |            SOLVE             |
        # +------------------------------+
        ...
        # {1-2-5} Time LabelFrame = [ (re)start, pause, resume ]
        # +------------------------------+
        # |            TIME              |
        # +------------------------------+        
        time_label_frame = tk.LabelFrame(option_frame, text="TIME")
        time_label_frame.grid(row=4, column=0, pady=self.Option_Frame_pady)
        self.Option_Frame_Add_Style(time_label_frame)
        
        count_down = CountDown(time_label_frame)
        
        # {1-2-6} Music LabelFrame = [ on, off ]
        # +------------------------------+
        # |            MUSIC             |
        # +------------------------------+        
        # music_label_frame = tk.LabelFrame(option_frame, text="MUSIC")
        # music_label_frame.grid(row=5, column=0, pady=self.Option_Frame_pady)
        # self.Option_Frame_Add_Style(music_label_frame)
        
        # # making a button which trigger the function so sound can be playeed
        # on_button = tk.Button(music_label_frame, text="On", command=self.play)
        # on_button.grid(row=0,column=0,padx=self.Option_Button_padx, pady=self.Option_Button_pady)
        # self.Option_Button_Add_Style(on_button)
